        ...
        <b-row class="p-4">
            ...
            <b-col md="6" class="middle mt-5">
                ...
                <b-form @submit.prevent="logUser">
                    <b-form-group label="Login to start Scheduling" class="text-center">

                        <b-form-input label="Login" placeholder="Name" class="p-4 m-2 w-75 mx-auto" v-model="Uname"></b-form-input>
                        <b-button type="submit" class="p-3 w-50 m-3 lgbtn">Login</b-button>
                    </b-form-group>
...
export default {
    ...
    methods: {
        ...mapActions(['setName', 'getCategory']),
        logUser() {
